...
public class BalanceBatch {
    ...
    private Queue<Pincode> queue = new ConcurrentLinkedQueue<>(); // what is the use of this
    private static final int BATCH_SIZE = 50_000;// number of rows
    ...
    public void send(Pincode value) {
        queue.add(value);
    }
